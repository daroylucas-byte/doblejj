...
const MobileHeader: React.FC<MobileHeaderProps> = ({ onMenuClick }) => {
    return (
        <header className="shrink-0 lg:hidden border-b border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex items-center justify-between px-4 sticky top-0 z-50 w-full transition-colors duration-300 pt-[calc(env(safe-area-inset-top)+0.5rem)] pb-2 min-h-[4rem]">
